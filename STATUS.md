...
- `P2-H Quality` - malicious fixtures, UAT/benchmark expansion, compatibility matrix (`#58`) - owner: `codex-gpt5`
...
1. `P2-I Memory Research` - memory architecture options/tradeoffs and recommendation (`#60`)
